...
downloadBtn.addEventListener("click", function () {
  ...
  // Header bar
  doc.setFillColor(45, 90, 78); // --accent color
  ...
  doc.text('COVERCRAFT', margin, 8);

  // Letter content
  doc.setFont('times', 'normal'); // serif font for letter body
  doc.setFontSize(11.5);
  doc.setTextColor(26, 26, 24); // --ink color
  ...
  doc.setDrawColor(226, 223, 215); // --border color
  doc.setLineWidth(0.3);
  doc.line(margin, pageHeight - 14, pageWidth - margin, pageHeight - 14);

  doc.setFont('helvetica', 'normal');
  doc.setFontSize(8);
  doc.setTextColor(176, 176, 168); // --ink-faint
  doc.text('Generated by CoverCraft · AI-Powered Cover Letters', margin, pageHeight - 8);
